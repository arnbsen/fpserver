...
/**
 * REST controller for managing {@link com.cse.domain.Student}.
 */
@RestController
@RequestMapping("/api")
public class StudentResource {
    ...
    @GetMapping("/students/byuserid/{id}")
    public ResponseEntity<StudentDTO> getstudentbyDeviceID(@PathVariable String id) {
